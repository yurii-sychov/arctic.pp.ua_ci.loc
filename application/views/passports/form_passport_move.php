		...
		<div class="card-body">
			<div class="row">
				<div class="col-md-6 mb-3">
					...
					<input type="text" class="form-control" id="idSubdivisionMoveOld" disabled>
				</div>
				<div class="col-md-6 mb-3">
					<label for="idCompleteRenovationObjectMoveOld" class="form-label">Підстанція</label>
					<input type="text" class="form-control" id="idCompleteRenovationObjectMoveOld" disabled>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-6 mb-3">
					...
					<input type="text" class="form-control" id="idSpecificRenovationObjectMoveOld" disabled>
				</div>
				<div class="col-md-6 mb-3">
					<label for="idPlaceMoveOld" class="form-label">Місце встановлення</label>
					<input type="text" class="form-control" id="idPlaceMoveOld" disabled>
				</div>
			</div>
		</div>
	</div>
