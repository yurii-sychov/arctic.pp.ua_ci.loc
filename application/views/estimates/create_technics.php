<div class="card">
	...
	<div class="card-body">
		...
		<form method="POST">
			...
			<div class="row my-2">
				<?php foreach ($technics as $k => $item) : ?>
					<div class="col-lg-4">
						<input type="checkbox" class="form-check-input" id="Id_<?php echo $item->id; ?>" name="technic_id[]" value="<?php echo $item->id; ?>" <?php echo $item->checked ? 'checked disabled' : NULL; ?> />
